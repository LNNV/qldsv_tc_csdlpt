...
{
    public partial class frptDanhSachSinhVienLTC : Form
    {
        private BindingSource bds_dspm = new BindingSource();
        public frptDanhSachSinhVienLTC()
        {
            InitializeComponent();
        }
        ...
        private void frptDanhSachSinhVienLTC_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dS.NIENKHOA' table. You can move, or remove it, as needed.
            loadData();
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            xrptDanhSachSinhVienLTC rpt = new xrptDanhSachSinhVienLTC(cmbNienKhoa.Text, int.Parse(cmbHocKy.Text), lblMaMH.Text, int.Parse(txtNhom.Text));
        ...
        private void frptDanhSachSinhVienLTC_FormClosing(object sender, FormClosingEventArgs e)
        {
